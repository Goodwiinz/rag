...
## 2024-07-14 - FileList Checkbox Accessibility
**Learning:** Checkboxes in list items for selecting documents lacked an aria-label, making them inaccessible to screen readers, and the list item containers themselves lacked focus-visible styling, hindering keyboard navigation.
**Action:** Always ensure that dynamically generated checkboxes have an explicit aria-label (e.g., using the document title) and that interactive list items have explicit focus-visible utility classes.
