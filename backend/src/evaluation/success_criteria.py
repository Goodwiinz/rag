...
class RAGSuccessCriteria:
    ...
    def _define_modality_requirements(self) -> Dict[ModalityType, Dict[str, Any]]:
        ...
        return {
            ...
            ModalityType.AUDIO: {
                ...
                "quality_metrics": [
                    "transcription_wer",
                    "speaker_diarization_der",
                    "emotion_accuracy",
                    "keyword_detection_f1",
                    "classification_accuracy",
                ],
                "minimum_accuracy": 0.85,
            ...
            ModalityType.VIDEO: {
                ...
                "quality_metrics": [
                    "frame_extraction_quality",
                    "scene_detection_accuracy",
                    "action_recognition_map",
    ...
    def get_success_criteria_for_query_type(
    ...
    def calculate_overall_success_score(
        self, metric_scores: Dict[str, float], query_type: Optional[QueryType] = None
    ) -> Dict[str, Any]:
        """
        ...
        for metric_name, score in metric_scores.items():
            if metric_name in self.thresholds:
                ...
                if query_type and query_type in self.query_type_requirements:
                    required_metrics = self.query_type_requirements[query_type][
                        "success_metrics"
                    ]
        ...
        if query_type:
            success_threshold = self.query_type_requirements.get(query_type, {}).get(
                "minimum_threshold", 0.75
            )
    ...
    def validate_evaluation_completeness(
        ...
        if query_type and query_type in self.query_type_requirements:
            query_metrics = set(
                self.query_type_requirements[query_type]["success_metrics"]
            )
        ...
        completeness_percentage = (
            len(evaluated_metrics & required_metrics) / len(required_metrics)
        ) * 100
