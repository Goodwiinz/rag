...
from .metrics import track_performance, record_histogram, increment_counter
...
class CacheManager:
    ...
    def set(self, key: str, value: Any, cache_level: str = 'memory', ttl: Optional[int] = None):
        """Set value in cache."""
        if cache_level == 'memory':
            with self._lock:
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        return {
            'memory_cache': {
                ...
                'usage_percent': (len(self.memory_cache) / self.cache_config['memory']['max_size']) * 100
            },
            'operations': {
