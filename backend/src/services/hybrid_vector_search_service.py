...
from .bm25_service import bm25_service, SparseVector
...
class HybridVectorSearchService:
    ...
    def search_dense(
        ...
        try:
            ...
            return [
                (str(r["id"]), r["score"], r.get("payload", {}))
                for r in results
            ]
        ...
        try:
            ...
            for doc_id, score, payload in fused_results[:config.limit]:
                metadata = VectorMetadata(
                    ...
                    organization_id=payload.get("organization_id", organization_id or ""),
    ...
    def _boost_with_bm25(
        ...
        for doc_id, dense_score, payload in dense_results:
            ...
            if doc_text:
                ...
                ) if doc_sparse.indices else 0.0
