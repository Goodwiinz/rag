...
from src.services.models.visualization_models import GraphSizeCategory
...
class PerformanceOptimizer:
    ...
    def get_optimizations(self, size_category: GraphSizeCategory) -> Dict[str, Any]:
        ...
        if size_category == GraphSizeCategory.SMALL:
            ...
            optimizations = {
                "sample_nodes": 1000,
                "filter_edges": {"min_strength": 0.2, "remove_weak_edges": True},
                "simple_layout": True,
    ...
    def get_layout_recommendations(self, size_category: GraphSizeCategory) -> List[str]:
        ...
        if size_category == GraphSizeCategory.SMALL:
            ...
            recommendations = ["force_directed", "hierarchical", "circular", "grid"]
        elif size_category == GraphSizeCategory.LARGE:
            recommendations = ["grid", "hierarchical", "circular"]
        elif size_category == GraphSizeCategory.EXTRA_LARGE:
            recommendations = ["grid", "random"]  # Fastest for very large graphs

        return recommendations

    def get_rendering_settings(
        self, size_category: GraphSizeCategory
    ) -> Dict[str, Any]:
    ...
    def estimate_memory_usage(
        ...
        node_memory = node_count * (
            base_node_memory + layout_memory_per_node + style_memory_per_node
        )
        ...
        return {
            ...
            "style_memory_mb": (
                (node_count * style_memory_per_node)
                + (edge_count * style_memory_per_edge)
            )
            / (1024 * 1024),
    ...
    def optimize_for_device(
        self, size_category: GraphSizeCategory, device_info: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def get_progressive_loading_config(
        self, size_category: GraphSizeCategory
    ) -> Dict[str, Any]:
