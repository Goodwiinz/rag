...
class LLMJudgeService:
    ...
    def __init__(
        ...
        self.api_key = (
            ...
            or settings.AZURE_OPENAI_CHAT_API_KEY
    ...
    async def evaluate_answer_relevancy(self, query: str, answer: str) -> JudgeScore:
        """
...
"""
    ...
    async def _call_judge(self, prompt: str, criteria: JudgeCriteria) -> JudgeScore:
        """
        ...
        try:
            ...
            is_gpt5 = (
                "gpt-5" in self.deployment_name.lower()
