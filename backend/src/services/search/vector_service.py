...
class VectorService:
    ...
    def ensure_collection_exists(
        self, collection_type: VectorCollectionType, vector_size: int = 1536
    ):
    ...
    def insert_vectors(
        self, collection_type: VectorCollectionType, vectors: List[VectorEntry]
    ) -> VectorOperationResult:
            ...
            for vector_entry in vectors:
                point = PointStruct(
                    ...
                    payload={
                        ...
                        "metadata": json.loads(vector_entry.metadata.json())
                        if hasattr(vector_entry.metadata, "json")
                        else vector_entry.metadata.dict(),
    ...
    def search_vectors(
        self, request: VectorSearchRequest, query_vector: List[float]
    ) -> VectorSearchResponse:
    ...
    def delete_vectors(
        self, collection_type: VectorCollectionType, vector_ids: List[str]
    ) -> VectorOperationResult:
    ...
    def get_collection_stats(
        self, collection_type: VectorCollectionType
        ...
        try:
            ...
            for collection_info in collections.collections:
                stats = self.get_collection_stats(
                    VectorCollectionType(collection_info.name)
                )
                if stats:
    ...
    def delete_collection(
        self, collection_type: Union[VectorCollectionType, str]
    ) -> VectorOperationResult:
        ...
        try:
            collection_name = (
                ...
                if hasattr(collection_type, "value")
