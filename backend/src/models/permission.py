...
SYSTEM_PERMISSIONS = [
    ...
    (
        "api_read",
        "Read API",
        "Access API endpoints for reading data",
    ...
    (
        "api_write",
        "Write API",
        "Access API endpoints for writing data",
        PermissionCategory.API,
        PermissionScope.WRITE,
    ),
    (
        "api_delete",
        "Delete API",
        "Access API endpoints for deleting data",
        PermissionCategory.API,
        PermissionScope.DELETE,
    ),
    # Billing permissions
    ...
    (
        "billing_manage",
        "Manage Billing",
        "Manage billing settings and subscriptions",
        PermissionCategory.BILLING,
        PermissionScope.MANAGE,
    ),
    # Audit permissions
    ...
    (
        "audit_manage",
        "Manage Audit",
        "Configure audit settings and retention",
        PermissionCategory.AUDIT,
        PermissionScope.MANAGE,
    ),
]
