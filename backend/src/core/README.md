...
| `db_retry.py`          | `@retry_on_pool_exhaustion` decorator: exponential backoff on `OperationalError` pool-exhaustion keywords; works for both sync and async callables.                                                                                                                             |
