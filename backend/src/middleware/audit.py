...
class AuditMiddleware(BaseHTTPMiddleware):
    ...
    async def _log_request_response(self, request_info: Dict[str, Any], response_info: Dict[str, Any]):
        ...
        try:
            ...
            severity = self._determine_severity(response_info['status_code'], request_info['path'])
            ...
            resource_type, resource_id = self._extract_resource_info(request_info['path'])
    ...
    async def _log_error(self, request_info: Dict[str, Any], error_message: str, response_time: float):
        """Log error event"""
        try:
    ...
    def _determine_event_type(self, request_info: Dict[str, Any], response_info: Dict[str, Any]) -> str:
