...
class DatabaseTestRunner:
    ...
    async def run_all_tests(self, database_types: Optional[List[str]] = None) -> Dict[str, Any]:
        """Run all tests for specified databases"""
        databases_to_test = database_types or ['postgresql', 'neo4j', 'redis', 'qdrant']

        logger.info(f"Starting comprehensive test suite for databases: {databases_to_test}")
        ...
        for category in test_categories:
            ...
            category_results = await self._run_test_category(category, databases_to_test)
    ...
    async def _run_test_category(self, category: TestType, database_types: List[str]) -> Dict[str, Any]:
        ...
        for db_type in database_types:
            ...
            for test_method_name in test_methods:
                test_result = await self._run_single_test(test_method_name, db_type, category)
    ...
    def _get_test_methods_for_category(self, category: TestType, database_type: str) -> List[str]:
    ...
    async def _run_single_test(self, test_method_name: str, database_type: str, test_type: TestType) -> TestResult:
        ...
        try:
            ...
            test_result.error_message = f"Test timed out after {self.config.test_timeout_seconds} seconds"
    ...
    async def test_postgresql_connectivity(self, database_type: str, test_result: TestResult):
    ...
    async def test_postgresql_query_performance(self, database_type: str, test_result: TestResult):
        ...
        try:
            ...
            assert avg_query_time < 1000, f"Average query time {avg_query_time:.2f}ms exceeds threshold"
            test_result.assertions_passed += 1
    ...
    async def test_postgresql_load_handling(self, database_type: str, test_result: TestResult):
        ...
        try:
            ...
            assert successful_operations >= 8, f"Too many failed operations: {len(tasks) - successful_operations}"
            test_result.assertions_passed += 1
    ...
    # Neo4j Test Methods
    async def test_neo4j_connectivity(self, database_type: str, test_result: TestResult):
    ...
    async def test_neo4j_graph_traversal_performance(self, database_type: str, test_result: TestResult):
        ...
        try:
            ...
            async with driver.session() as session:
                ...
                assert avg_query_time < 2000, f"Average query time {avg_query_time:.2f}ms exceeds threshold"
                test_result.assertions_passed += 1
    ...
    # Redis Test Methods
    async def test_redis_connectivity(self, database_type: str, test_result: TestResult):
    ...
    async def test_redis_cache_performance(self, database_type: str, test_result: TestResult):
        ...
        try:
            ...
            assert ops_per_second > 1000, f"Operations per second {ops_per_second:.2f} below threshold"
            test_result.assertions_passed += 1
    ...
    # Qdrant Test Methods
    async def test_qdrant_connectivity(self, database_type: str, test_result: TestResult):
        ...
        try:
            ...
            assert isinstance(collections.collections, list), "Failed to get collections"
            test_result.assertions_passed += 1
    ...
    async def test_qdrant_vector_search_performance(self, database_type: str, test_result: TestResult):
        ...
        try:
            ...
            assert avg_search_time < 0.1, f"Average search time {avg_search_time*1000:.2f}ms exceeds threshold"
            test_result.assertions_passed += 1
    ...
    async def test_cross_db_operations(self, database_type: str, test_result: TestResult):
        ...
        try:
            ...
            assert successful_syncs >= 2, f"Too many failed syncs: {len(sync_operations) - successful_syncs}"
            test_result.assertions_passed += 1
    ...
    def generate_test_report(self, test_results: Optional[List[TestResult]] = None) -> Dict[str, Any]:
        ...
        report = {
            ...
            'summary': {
                ...
                'success_rate': 0,
                'total_duration_seconds': sum(r.duration_seconds for r in results_to_analyze),
        ...
        if results_to_analyze:
            ...
            report['summary']['avg_duration_seconds'] = (
                report['summary']['total_duration_seconds'] / report['summary']['total_tests']
            )
        ...
        for db_type in ['postgresql', 'neo4j', 'redis', 'qdrant']:
            ...
            if db_tests:
                ...
                report['by_database_type'][db_type] = {
                    ...
                    'avg_duration_seconds': sum(r.duration_seconds for r in db_tests) / len(db_tests)
                }
        ...
        report['failed_tests'] = [
            ...
            for r in results_to_analyze if not r.success
        ]
    ...
    def get_test_results(self, database_type: Optional[str] = None,
