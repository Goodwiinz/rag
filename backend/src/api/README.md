...
| `diagnostics`     | Retrieval pipeline diagnostics                                                                                                            | `/api/v1/diagnostics`                                                                                                           |
...
| `search`          | Hybrid search (Qdrant + PG), knowledge-graph query, search quality                                                                        | `/api/v1/search`, `/api/v1/knowledge-graph`, `/api/v1/search-quality`                                                           |
