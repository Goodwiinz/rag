...
async def get_quality_metrics_for_recommendations(
    ...
    try:
        ...
        from src.services.quality.performance_dashboard_service import MetricTimeRange
        ...
        from src.services.quality.user_behavior_service import MetricTimeRange as BehaviorTimeRange
