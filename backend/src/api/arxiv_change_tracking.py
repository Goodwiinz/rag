...
from src.services.arxiv_change_tracker import change_tracker, track_arxiv_changes
...
class CategoryTrackingRequest(BaseModel):
    ...
    update_database: bool = Field(default=True, description="Whether to apply changes to database")
...
async def get_change_history(
    paper_id: Optional[str] = Query(None, description="Specific paper ID to get history for"),
