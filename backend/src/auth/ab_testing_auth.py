...
from sqlalchemy import Column, String, Boolean, DateTime, Enum, ForeignKey, Integer, UUID, ARRAY
...
async def get_current_user_or_service(
    user_credentials: Optional[HTTPAuthorizationCredentials] = Security(user_auth_scheme),
    service_credentials: Optional[HTTPAuthorizationCredentials] = Security(service_auth_scheme),
    db: Session = Depends(get_db)
    ...
    if service_credentials:
        service_context = await authenticate_service(service_credentials.credentials, db)
        if service_context:
    ...
    def decorator(func: Callable):
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            if isinstance(current_user, User):
                ...
                if not service_context or permission not in service_context.get('permissions', []):
                    raise HTTPException(
                        status_code=status.HTTP_403_FORBIDDEN,
...
def require_experiment_access(
    ...
    required_permissions: List[ABTestingPermission]
):
    """
...
def create_default_permissions():
    ...
    permissions = [
        ...
        {"name": ABTestingPermission.EXPERIMENT_CREATE, "description": "Create A/B testing experiments"},
        {"name": ABTestingPermission.EXPERIMENT_READ, "description": "Read A/B testing experiments"},
        {"name": ABTestingPermission.EXPERIMENT_UPDATE, "description": "Update A/B testing experiments"},
        {"name": ABTestingPermission.EXPERIMENT_DELETE, "description": "Delete A/B testing experiments"},
        {"name": ABTestingPermission.EXPERIMENT_START, "description": "Start A/B testing experiments"},
        {"name": ABTestingPermission.EXPERIMENT_STOP, "description": "Stop A/B testing experiments"},
        {"name": ABTestingPermission.EXPERIMENT_ANALYZE, "description": "Analyze A/B testing results"},

        # Variant permissions
        {"name": ABTestingPermission.VARIANT_CREATE, "description": "Create experiment variants"},
        {"name": ABTestingPermission.VARIANT_READ, "description": "Read experiment variants"},
        {"name": ABTestingPermission.VARIANT_UPDATE, "description": "Update experiment variants"},
        {"name": ABTestingPermission.VARIANT_DELETE, "description": "Delete experiment variants"},

        # Metrics permissions
        {"name": ABTestingPermission.METRICS_SUBMIT, "description": "Submit experiment metrics"},
        {"name": ABTestingPermission.METRICS_READ, "description": "Read experiment metrics"},
        {"name": ABTestingPermission.METRICS_ANALYZE, "description": "Analyze experiment metrics"},

        # Routing permissions
        {"name": ABTestingPermission.ROUTING_ASSIGN, "description": "Assign experiment variants"},
        {"name": ABTestingPermission.ROUTING_OVERRIDE, "description": "Override experiment assignments"},

        # Segment permissions
        {"name": ABTestingPermission.SEGMENT_CREATE, "description": "Create user segments"},
        {"name": ABTestingPermission.SEGMENT_READ, "description": "Read user segments"},
        {"name": ABTestingPermission.SEGMENT_UPDATE, "description": "Update user segments"},
        {"name": ABTestingPermission.SEGMENT_DELETE, "description": "Delete user segments"},

        # Organization permissions
        {"name": ABTestingPermission.ORG_ADMIN, "description": "Organization A/B testing administration"},
        {"name": ABTestingPermission.ORG_ANALYTICS, "description": "Organization analytics access"},

        # System permissions
        {"name": ABTestingPermission.SYSTEM_ADMIN, "description": "System-wide A/B testing administration"},
        {"name": ABTestingPermission.SYSTEM_ANALYTICS, "description": "System-wide analytics access"},
    ]
