...
def test_bm25_combined_ranking():
    ...
    dense_results = [
        ...
        (
            0.75,
            "Image recognition using neural network architectures for classification",
        ),
