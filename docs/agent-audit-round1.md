...
| M7 | invalid connector name silently degrades to fan-out across ALL connectors (tools.py:771-776, tools_impl.py:2992-3018) — typo → ~250-connector HTTP burst | med | fixed | clawd | #1505 | 08-19 |
| M8 | wrapper silently truncates paper_ids to 10 (tools.py:270) — 15 requested → 10 land, "Ingested 10 of 10", 5 vanish, impl's >10 error unreachable | med | fixed | clawd | #1505 | 08-19 |
...
| L7 | compare_documents cap mismatch: wrapper 10, impl 5 (tools.py:80,528 / tools_impl.py:2299) — guaranteed error loop 6-10 | low | fixed | clawd | #1505 | 08-19 |
| L8 | `export_bibliography` never caps document_ids (tools.py:676-692) — unbounded IN-clause | low | fixed | clawd | #1505 | 08-19 |
| L9 | `execute_code` falls back to thread_id="default" (tools.py:723) — shared stateful sandbox, cross-conversation leakage | low | fixed | clawd | #1505 | 08-19 |
