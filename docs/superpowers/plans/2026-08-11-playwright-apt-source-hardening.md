...
Commit only the helper, regression test, workflow change, and this plan. Push `codex/playwright-apt-source-hardening`, open a follow-up PR against `develop`, then monitor E2E and Release Gate until both complete successfully.
