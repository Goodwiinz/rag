...
def create_sample_knowledge_graph():
    ...
    # Neo4j connection (from environment, no hardcoded secrets)
            ...
            entities = [
                {
                    ...
                    "type": "Concept",
                    "description": "A structured representation of knowledge",
                },
                {
                    "name": "Neo4j",
                    "type": "Technology",
                ...
                },
                {
                    ...
                    "type": "Process",
                    "description": "Process of identifying entities in text",
                },
                {
            ...
            documents = [
                {
                    ...
                    "content": "This document describes the architecture of knowledge graphs...",
                },
                {
                    "title": "Neo4j Best Practices",
                    "content": "Best practices for using Neo4j graph database...",
                },
                {
                    "title": "RAG System Design",
                    "content": "Design principles for retrieval-augmented generation systems...",
                },
            ]
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(
            "🔍 You can now explore the graph in Neo4j Browser at http://localhost:7474"
        )
