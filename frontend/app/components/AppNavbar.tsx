...
export function AppNavbar() {
    ...
    ? [
        {
          ...
          icon: 'Upload',
          description:
            'Jump directly into managing and monitoring your documents.',
        },
      ]
    : [
        {
          ...
          icon: 'LogIn',
          description:
            'Access your existing workspace and continue where you left off.',
        },
        {
          href: '/register',
  ...
  return (
    <Navbar02
      ...
      onCtaClick={() =>
        router.push(isAuthenticated ? '/documents/upload' : '/register')
      }
