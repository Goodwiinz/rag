              ...
              <div className="space-y-3">
                {group.relationships.map((relationship) => {
                  ...
                  return (
                    <div
                      key={relationship.id}
                      className="border rounded-lg p-4 hover:bg-(--nous-bg-3) transition-colors"
                    >
                                    ...
                                    {relationship.document_ids
                                      ...
                                      .map((docId, index) => (
                                        <Badge
                                          key={docId}
                                          variant="secondary"
                                          className="text-xs cursor-pointer hover:bg-(--nous-bg-3)"
                                          onClick={() =>
                              ...
                              {relationship.metadata &&
                                Object.keys(relationship.metadata).length >
                                  ...
                                  <div>
                                    ...
                                    <div className="bg-(--nous-bg-2) rounded p-2 text-xs">
                                      {Object.entries(
                                        relationship.metadata
                                      ).map(([key, value]) => (
                                        <div key={key}>
          ...
          {selectedRelationship && (
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  {getRelatedEntity(selectedRelationship.source_entity_id) ? (
                    ...
                    <div className="p-3 bg-(--nous-bg-2) rounded text-muted-foreground">
                      Entity not found
                    </div>
                  )}
                </div>
              ...
              <div>
                ...
                <div className="p-3 bg-(--nous-bg-2) rounded italic">
