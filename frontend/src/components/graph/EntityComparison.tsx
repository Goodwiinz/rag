              ...
              return (
                ...
                >
                  ...
                  <Button
                    ...
                    className="h-6 w-6 p-0 hover:bg-(--nous-mars)/10"
                  >
              ...
              {availableEntities
                ...
                .map((entity) => {
                  ...
                  return (
                    <div
                      key={entity.id}
                      className="flex items-center justify-between p-3 border rounded-lg hover:bg-(--nous-bg-3) cursor-pointer"
                    ...
                    {relationshipAnalysis.sharedDocuments
                      ...
                      .map((docId) => {
                        ...
                        return doc ? (
                          <div
                            key={docId}
                            className="flex items-center justify-between p-2 bg-(--nous-bg-2) rounded cursor-pointer hover:bg-(--nous-bg-3)"
                            onClick={() => onDocumentClick?.(docId)}
                          >
