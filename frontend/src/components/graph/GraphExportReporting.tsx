...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns/graphml">
  ...
  const startExport = useCallback(async () => {
    ...
    const templateConfig = reportTemplates.find(
  ...
  const currentTemplate = reportTemplates.find(
    (t) => t.id === selectedTemplate
  );
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-6">
            {/* Statistics Overview */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-(--nous-bg-2) rounded-lg">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-foreground">
                  {graphStatistics.totalRelationships}
                </div>
                ...
                {exportFormats.map((format) => {
                  ...
                  return (
                    <div
                      key={format.id}
                      className={cn(
                        'border rounded-lg p-4 cursor-pointer hover:border-(--nous-sol) transition-colors',
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <FormatIcon className="h-6 w-6 text-(--nous-fg-accent-safe)" />
                        <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {reportTemplates.map((template) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <TemplateIcon className="h-5 w-5 text-(--nous-fg-accent-safe)" />
                        <div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-foreground">
                {currentFormat && (
                  <span>
                    {currentFormat.maxSize &&
                      `Max size: ${currentFormat.maxSize}MB • `}
                      ...
                      {job.status === 'processing' && (
                        <div className="w-24">
                          <div className="w-full bg-(--nous-bg-3) rounded-full h-2">
                            <div
                              className="bg-(--nous-sol) h-2 rounded-full transition-all duration-300"
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-(--nous-bg-2) rounded-lg">
                ...
                <pre className="text-xs bg-background p-3 rounded border overflow-auto max-h-64">
                  ...
                  {generateExportData(selectedFormat, selectedTemplate).length >
                    500 && '\n...'}
                </pre>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      {exportFormats
                        .filter((f) => f.supportedData.includes('statistics'))
                        .map((format) => (
