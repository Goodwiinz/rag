...
export function CitationEditModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl bg-(--nous-bg-1) border-(--nous-border-1) max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-mono text-lg text-(--nous-fg-1)">
            Edit Citation
          </DialogTitle>
          <DialogDescription className="font-mono text-sm text-(--nous-fg-3)">
        ...
        <div className="space-y-6 py-4">
          ...
          {/* Auto-Lookup Section */}
          <div className="p-4 rounded-lg border border-(--nous-border-1) bg-(--nous-bg-2)">
            <Label className="text-xs font-mono font-medium text-(--nous-fg-1) uppercase tracking-wider mb-3 block">
              Auto-Lookup
            </Label>
            ...
            <div className="flex gap-2">
              <div className="flex-1 flex gap-2">
                <select
                  ...
                  className="px-3 py-2 rounded-lg bg-(--nous-bg-3) border border-(--nous-border-1) text-sm font-mono text-(--nous-fg-1) focus:outline-hidden focus:ring-2 focus:ring-(--nous-sol)/50"
                >
                ...
                <Input
                  ...
                  className="flex-1 bg-(--nous-bg-3) border-(--nous-border-1) font-mono text-sm"
                  disabled={loading}
                />
              </div>
              ...
              <Button
                ...
                className="bg-(--nous-sol) text-(--nous-bg-1) hover:shadow-[0_0_20px_var(--nous-sol-glow)] font-mono text-xs font-bold"
              >
                {loading ? (
                  <>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label
                htmlFor="title"
                className="text-xs font-mono font-medium text-(--nous-fg-1) uppercase tracking-wider"
              >
                Title *
              </Label>
              <Input
                ...
                className="bg-(--nous-bg-3) border-(--nous-border-1) font-mono text-sm"
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="bg-(--nous-bg-3) border-(--nous-border-1) font-mono text-sm min-h-[120px]"
        ...
        <DialogFooter className="gap-2">
          <Button
            ...
            className="font-mono text-xs border-(--nous-border-1) text-(--nous-fg-3)"
          >
            Cancel
          </Button>
          <Button
