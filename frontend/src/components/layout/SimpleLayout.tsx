            ...
            {isAuthenticated ? (
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2 px-3 py-1.5 rounded border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background",
                    userMenuOpen
                  ...
                  <div role="menu" className="absolute right-0 top-full mt-2 w-48 rounded border border-white/10 bg-card shadow-xl shadow-black/50 overflow-hidden">
                    ...
                    <div className="py-1" role="none">
                      <Link
                        ...
                        className="flex items-center gap-2 px-3 py-2 text-xs font-mono text-white/60 hover:text-white hover:bg-white/5 transition-colors focus-visible:outline-none focus-visible:bg-white/10"
                      >
                    ...
                    {/* Logout */}
                    <div className="border-t border-white/10 py-1" role="none">
                      <button
                        type="button"
                        role="menuitem"
                        onClick={() => {
                        ...
                        className="flex items-center gap-2 w-full px-3 py-2 text-xs font-mono text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-colors focus-visible:outline-none focus-visible:bg-red-500/20"
                      >
