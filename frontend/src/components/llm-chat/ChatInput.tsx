  ...
  return (
    <div className="p-6 pt-3">
      <div className="max-w-4xl mx-auto">
        <div className={`relative rounded-2xl border bg-[#0E1015] shadow-2xl transition-all \${
          ...
          <Textarea
            ...
            placeholder={selectedModel ? "Type your message... (Shift+Enter for new line)" : "Select a model above to start chatting..."}
