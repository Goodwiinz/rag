                ...
                <div className="max-h-40 overflow-y-auto border border-(--nous-border-1) rounded-md bg-(--nous-bg-1)">
                  {filteredSourceEntities.map(entity => (
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-xs font-mono hover:bg-(--nous-bg-3) transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-(--nous-sol) focus-visible:ring-offset-1"
                    >
                  ...
                  {path.nodes.map((node, nodeIndex) => (
                    <React.Fragment key={nodeIndex}>
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-md bg-(--nous-bg-3) border border-(--nous-border-1) hover:border-(--nous-sol) transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-(--nous-sol) focus-visible:ring-offset-1"
                      >
