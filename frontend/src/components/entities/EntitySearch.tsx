                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {results.entities.slice(0, 12).map((entity) => (
                    <button
                      ...
                      className="p-3 rounded-lg border border-[var(--nous-border-1)] bg-[var(--nous-bg-1)] hover:border-[var(--nous-sol)] transition-colors text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--nous-sol)] focus-visible:ring-offset-1"
                    >
