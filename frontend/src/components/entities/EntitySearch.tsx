        ...
        <CardContent className="p-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="font-mono text-sm bg-(--nous-bg-1) border-(--nous-border-1) text-(--nous-fg-1)"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card className="border-(--nous-border-1) bg-(--nous-bg-2)">
              <CardContent className="p-4">
                <div className="text-xs font-mono text-(--nous-fg-3) mb-1">
                  ENTITIES
                </div>
                <div className="text-2xl font-mono font-bold text-(--nous-sol)">
            ...
            <Card className="border-(--nous-border-1) bg-(--nous-bg-2)">
              <CardContent className="p-4">
                ...
                <div className="text-2xl font-mono font-bold text-(--nous-helios)">
            ...
            <Card className="border-(--nous-border-1) bg-(--nous-bg-2)">
              <CardContent className="p-4">
                <div className="text-xs font-mono text-(--nous-fg-3) mb-1 flex items-center gap-1">
            ...
            <Card className="border-(--nous-border-1) bg-(--nous-bg-2)">
              ...
              <CardContent className="p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {results.entities.slice(0, 12).map((entity) => (
                    <button
                      ...
                      className="p-3 rounded-lg border border-(--nous-border-1) bg-(--nous-bg-1) hover:border-(--nous-sol) transition-colors text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--nous-sol)]"
                    >
                      <div className="text-sm font-mono font-bold text-(--nous-fg-1)">
                        {entity.name}
                      </div>
                      <div className="text-xs font-mono text-(--nous-fg-3) mt-1">
                        {entity.entity_type}
                      </div>
                      <div className="text-xs font-mono text-(--nous-helios) mt-1">
                ...
                {results.entities.length > 12 && (
                  <p className="text-xs font-mono text-(--nous-fg-3) mt-3 text-center">
            ...
            <Card className="border-(--nous-border-1) bg-(--nous-bg-2)">
              ...
              <CardContent className="p-4 space-y-3">
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex gap-4 text-xs font-mono">
                        ...
                        <span className="text-(--nous-fg-3)">
                          Strength:{' '}
                          <span className="text-(--nous-helios)">
                    ...
                    <div className="text-xs font-mono text-(--nous-fg-1)">
                      {path.nodes.map((node, i) => (
                        <React.Fragment key={i}>
                          <span className="text-(--nous-sol)">{node.entity_name}</span>
                          {i < path.edges.length && (
                            <span className="text-(--nous-fg-3) mx-2">
                ...
                {results.paths.length > 5 && (
                  <p className="text-xs font-mono text-(--nous-fg-3) text-center">
