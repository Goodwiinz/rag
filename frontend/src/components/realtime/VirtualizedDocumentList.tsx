      ...
      return (
        <div className={cn('border border-border rounded-lg', className)}>
          <List
            ...
            className="scrollbar-thin scrollbar-thumb-(--nous-border-1) scrollbar-track-(--nous-bg-2)"
      ...
      {Array.from({ length: count }, (_, index) => (
        ...
        >
          <div className="flex items-center space-x-3">
            <div className="w-5 h-5 bg-(--nous-bg-3) rounded"></div>
            <div className="flex-1 space-y-2">
              <div className="h-4 bg-(--nous-bg-3) rounded w-3/4"></div>
              <div className="h-3 bg-(--nous-bg-2) rounded w-1/2"></div>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-20 h-2 bg-(--nous-bg-2) rounded"></div>
              <div className="w-16 h-6 bg-(--nous-bg-3) rounded"></div>
            </div>
          </div>
          {!compact && (
            <div className="mt-3 space-y-2">
              <div className="h-2 bg-(--nous-bg-2) rounded w-full"></div>
              <div className="h-2 bg-(--nous-bg-2) rounded w-4/5"></div>
            </div>
          )}
        </div>
      ))}
