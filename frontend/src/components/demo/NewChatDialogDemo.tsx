...
export function NewChatDialogDemo() {
  ...
  const [chatHistory, setChatHistory] = useState<{ assistant: Assistant; timestamp: Date }[]>([])
  ...
  const [assistants] = useState<Assistant[]>([
    ...
    },
    {
      ...
      avatar: "",
      category: "academic",
      capabilities: ["Literature review", "Data analysis", "Citation management", "Methodology"],
  ...
  const handleSelectAssistant = (assistant: Assistant) => {
    setChatHistory(prev => [{ assistant, timestamp: new Date() }, ...prev.slice(0, 4)])
              ...
              {chatHistory.map((chat, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`h-10 w-10 rounded-full bg-gradient-to-br ${chat.assistant.color} flex items-center justify-center text-white font-semibold`}>
