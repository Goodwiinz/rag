...
export function SkillHistory({
  ...
  canEdit,
  isRollingBack,
}: SkillHistoryProps): ReactElement {
  return (
    <section
      aria-labelledby="skill-history-heading"
      className="rounded-lg border border-border bg-card p-4"
    >
      <h2 id="skill-history-heading" className="font-medium">
        Version history
      </h2>
            ...
            >
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant={scanVariant(version.scan_state)}>
                    {version.scan_state}
                  </Badge>
                </div>
