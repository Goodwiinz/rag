...
export function ThreadMessageSearch({
  ...
  const [threadSortOrder, setThreadSortOrder] =
    useState<ThreadSearchSortOrder>('relevance');
  const [messageSortOrder, setMessageSortOrder] =
    useState<MessageSearchSortOrder>('relevance');
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {(
                          ['active', 'resolved', 'archived'] as ThreadStatus[]
                        ).map((status) => (
                          <Badge
                            key={status}
                            variant="outline"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 text-xs text-gray-500">
                      ...
                      {result.matching_message_count !== undefined &&
                        result.matching_message_count > 0 && (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="mt-1">
                    <Badge
                      variant="outline"
                      className={cn('text-xs', getRoleBadgeColor(result.role))}
                    >
                      {result.role}
                    </Badge>
                  </div>
