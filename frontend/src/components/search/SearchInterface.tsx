              ...
              <div className="p-2">
                ...
                {suggestions.auto_complete.map((suggestion, index) => (
                  <button
                    ...
                    className={cn(
                      'w-full text-left px-3 py-2.5 text-sm rounded-xl transition-all duration-150 flex items-center space-x-3 group focus-visible:ring-2 focus-visible:outline-none',
              ...
              <div className="p-2 border-t border-border/50 bg-muted/30">
                ...
                {suggestions.related_queries.map((related, index) => (
                  <button
                    ...
                    className={cn(
                      'w-full text-left px-3 py-2.5 text-sm rounded-xl transition-all duration-150 flex items-center justify-between group focus-visible:ring-2 focus-visible:outline-none',
                      selectedSuggestionIndex ===
      ...
      {!hasActiveFilters && !showFilters && (
        <div className="flex flex-wrap items-center justify-center gap-2 animate-in fade-in slide-in-from-top-1 duration-500">
          <button
            ...
            className={cn(
              'px-3 py-1.5 rounded-full text-xs font-medium border transition-all duration-200 flex items-center space-x-1.5 focus-visible:ring-2 focus-visible:outline-none',
              ...
              filters.modalities.map((m) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-1.5 hover:text-destructive focus-visible:ring-2 focus-visible:outline-none rounded-sm"
            ...
            {history.length === 0 ? (
              ...
              history.map((item) => (
                <button
                  ...
                  className="w-full text-left p-3 rounded-lg hover:bg-gray-50 transition-colors focus-visible:ring-2 focus-visible:outline-none"
                >
