              ...
              filters.modalities.map((m) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-1.5 hover:text-destructive focus-visible:ring-2 focus-visible:ring-destructive focus-visible:outline-none rounded-sm"
            ...
            {history.length === 0 ? (
              ...
              history.map((item) => (
                <button
                  ...
                  className="w-full text-left p-3 rounded-lg hover:bg-gray-50 transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                >
