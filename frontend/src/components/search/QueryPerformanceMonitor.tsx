...
const PerformanceDetail: React.FC<PerformanceDetailProps> = ({
  ...
  const getScoreColor = (score: number) => {
    if (score >= 90) return 'text-(--nous-terra)';
    if (score >= 80) return 'text-(--nous-corona)';
    if (score >= 70) return 'text-(--nous-corona)';
  ...
  const getImpactColor = (impact: string) => {
    switch (impact) {
      ...
      case 'high':
        return 'bg-(--nous-mars)/15 text-(--nous-mars)';
      default:
        return 'bg-(--nous-bg-3) text-(--nous-fg-1)';
    }
  };
            ...
            {['overview', 'latency', 'quality', 'resources', 'bottlenecks'].map(
              (tab) => (
                <button
                  ...
                  className={cn(
                    'py-2 px-1 border-b-2 font-medium text-sm capitalize focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
                    activeTab === tab
                      ? 'border-(--nous-sol) text-(--nous-fg-accent-safe)'
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="p-4 bg-(--nous-sol)/10 rounded-lg">
                  ...
                  <div className="text-sm text-(--nous-fg-accent-safe)">
                    Total Latency
                  </div>
                </div>

                <div className="p-4 bg-(--nous-terra)/10 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                ...
                <div className="p-4 bg-(--nous-sol)/10 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <CircleStackIcon className="h-5 w-5 text-(--nous-fg-accent-safe)" />
                    <span className="text-sm font-medium text-(--nous-fg-accent-safe)">
                ...
                <div className="p-4 bg-(--nous-corona)/10 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <BoltIcon className="h-5 w-5 text-(--nous-corona)" />
                    <span
                      className={cn(
                        'text-sm font-medium',
                  ...
                  <div className="text-2xl font-bold text-(--nous-corona)">
                    {metrics.resource_usage.cpu_percent}%
                  </div>
                  <div className="text-sm text-(--nous-corona)">
                    CPU Usage
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge
                            className={cn(
                              latency < 100
                                ? 'bg-(--nous-terra)/15 text-(--nous-terra)'
                                : latency < 300
                                  ? 'bg-(--nous-corona)/15 text-(--nous-corona)'
                                  : 'bg-(--nous-mars)/15 text-(--nous-mars)'
                            )}
                          >
                            {latency < 100
                              ? 'Fast'
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    {Object.entries(
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2">
                          <div className="w-24 bg-(--nous-bg-3) rounded-full h-2">
                            <div
                              className={cn(
                                'h-2 rounded-full',
                                score >= 90
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-(--nous-bg-2) rounded-lg">
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="p-4 bg-(--nous-sol)/10 rounded-lg">
                  <div className="flex items-center space-x-2 mb-3">
                    <CpuChipIcon className="h-5 w-5 text-(--nous-fg-accent-safe)" />
                    <h4 className="font-medium text-(--nous-fg-accent-safe)">
                      CPU Usage
                    </h4>
                  </div>
                  <div className="text-2xl font-bold text-(--nous-fg-accent-safe) mb-2">
                    {metrics.resource_usage.cpu_percent}%
                  </div>
                  <div className="w-full bg-(--nous-bg-3) rounded-full h-2">
                    <div
                ...
                <div className="p-4 bg-(--nous-terra)/10 rounded-lg">
                  <div className="flex items-center space-x-2 mb-3">
                    <CircleStackIcon className="h-5 w-5 text-(--nous-terra)" />
                    <h4 className="font-medium text-(--nous-terra)">
                      Memory Usage
                    </h4>
                  </div>
                  <div className="text-2xl font-bold text-(--nous-terra) mb-2">
                    {formatBytes(
                      metrics.resource_usage.memory_mb * 1024 * 1024
                    )}
                  </div>
                ...
                <div className="p-4 bg-(--nous-sol)/10 rounded-lg">
                  <div className="flex items-center space-x-2 mb-3">
                    <ServerIcon className="h-5 w-5 text-(--nous-fg-accent-safe)" />
                    <h4 className="font-medium text-(--nous-fg-accent-safe)">
                      Network
                    </h4>
                  </div>
            ...
            <div className="space-y-4">
              ...
              {metrics.bottlenecks.length > 0 ? (
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-3 mb-2">
                            <ExclamationTriangleIcon className="h-4 w-4 text-(--nous-corona)" />
                            <span className="font-medium text-foreground">
                          ...
                          <p className="text-sm text-(--nous-fg-accent-safe)">
                ...
                <div className="text-center py-8">
                  <CheckCircleIcon className="h-12 w-12 text-(--nous-terra) mx-auto mb-4" />
...
> = ({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'excellent':
        return 'text-(--nous-terra)';
      case 'good':
        return 'text-(--nous-corona)';
  ...
  return (
    <div className={cn('space-y-4', className)}>
      {/* Performance Header */}
      <div className="flex items-center justify-between p-4 bg-(--nous-bg-2) rounded-lg">
        <div className="flex items-center space-x-3">
          {isMonitoring ? (
            <div className="h-5 w-5 animate-spin rounded-full border-2 border-(--nous-sol) border-t-transparent" />
          ) : (
            <ChartBarIcon className="h-5 w-5 text-(--nous-fg-accent-safe)" />
          )}
          <div>
        ...
        <div className="flex items-center space-x-3">
          {metrics.bottlenecks.length > 0 && (
            <div className="flex items-center space-x-1 text-(--nous-corona)">
      ...
      <div className="grid grid-cols-4 gap-3">
        <div className="flex items-center space-x-2 p-3 bg-(--nous-sol)/10 rounded-lg">
          <ClockIcon className="h-4 w-4 text-(--nous-fg-accent-safe)" />
          <div>
            <div className="text-sm font-medium text-(--nous-fg-accent-safe)">
              {metrics.total_latency_ms}ms
            </div>
            <div className="text-xs text-(--nous-fg-accent-safe)">
              Latency
            </div>
          </div>
        </div>

        <div className="flex items-center space-x-2 p-3 bg-(--nous-terra)/10 rounded-lg">
          <CheckCircleIcon className="h-4 w-4 text-(--nous-terra)" />
          <div>
            <div className="text-sm font-medium text-(--nous-terra)">
              {Math.round(
                metrics.quality_metrics.rag_triad_compliance.answer_relevancy
              )}
              %
            </div>
            <div className="text-xs text-(--nous-terra)">
              Answer Quality
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 p-3 bg-(--nous-sol)/10 rounded-lg">
          <CircleStackIcon className="h-4 w-4 text-(--nous-fg-accent-safe)" />
          <div>
            <div className="text-sm font-medium text-(--nous-fg-accent-safe)">
              {Math.round(metrics.cache_performance.cache_hit_rate * 100)}%
            </div>
        ...
        <div className="flex items-center space-x-2 p-3 bg-(--nous-corona)/10 rounded-lg">
          <CpuChipIcon className="h-4 w-4 text-(--nous-corona)" />
          <div>
            <div className="text-sm font-medium text-(--nous-corona)">
              {metrics.resource_usage.cpu_percent}%
            </div>
            <div className="text-xs text-(--nous-corona)">CPU</div>
          </div>
        </div>
      </div>
      ...
      {metrics.bottlenecks.length > 0 && (
        <div className="flex items-center space-x-2 p-3 bg-(--nous-corona)/10 rounded-lg">
          ...
          <Button
            ...
            size="sm"
            onClick={() => setShowDetailDialog(true)}
            className="h-6 text-xs text-(--nous-corona) hover:text-(--nous-fg-1)"
          >
            View Details
          </Button>
        </div>
      ...
      {isMonitoring && (
        <div className="flex items-center space-x-2 p-3 bg-(--nous-sol)/10 rounded-lg">
          <div className="h-3 w-3 animate-ping bg-(--nous-sol) rounded-full" />
