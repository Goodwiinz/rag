          ...
          >
            ...
            >
              <div className="flex items-center gap-0.5">
                <label
                  className="grid place-items-center w-11 h-11 rounded-md cursor-pointer transition-all focus-visible:ring-2 focus-visible:ring-[var(--nous-sol)] focus-visible:outline-none"
                  tabIndex={0}
                  onKeyDown={(e) => {
