          ...
          <div className="space-y-4">
              ...
              <input
                ...
                className={`mt-1 appearance-none relative block w-full px-3 py-2 border ${
                  validationErrors.firstName
                    ? 'border-red-300'
                    : 'border-border'
                } placeholder-gray-500 text-foreground rounded-md focus:outline-hidden focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm`}
                placeholder="John"
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 appearance-none relative block w-full px-3 py-2 border border-border placeholder-gray-500 text-foreground rounded-md focus:outline-hidden focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
