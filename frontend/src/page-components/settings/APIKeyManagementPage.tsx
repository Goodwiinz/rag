  ...
  return (
    <div className="space-y-8 px-6 pb-16 pt-6 md:space-y-10 md:px-10 md:pt-8 lg:px-12">
      <header className="space-y-4">
        <Link
          href="/settings"
          className="inline-flex items-center gap-1.5 rounded-md text-sm text-(--nous-fg-3) transition-colors hover:text-(--nous-fg-1) focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-(--nous-sol)/40"
        >
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm text-(--nous-fg-3)">
      ...
      <section aria-labelledby="api-keys-heading" className="space-y-4">
        ...
        <Card className="rounded-2xl border-(--nous-border-1) bg-(--nous-bg-2) shadow-none">
          <CardContent className="flex flex-col items-center gap-3 px-6 py-14 text-center">
            <div
              className="flex h-12 w-12 items-center justify-center rounded-xl bg-(--nous-sol-glow) text-(--nous-sol)"
              aria-hidden="true"
            >
            ...
            <div className="space-y-1.5">
              ...
              <p className="max-w-md text-sm text-(--nous-fg-3)">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section aria-labelledby="providers-heading" className="space-y-3">
          ...
          <Card className="h-full rounded-2xl border-(--nous-border-1) bg-(--nous-bg-2) shadow-none">
            <CardContent className="flex flex-col items-center gap-3 px-6 py-12 text-center">
              ...
              <div className="space-y-1.5">
                ...
                <p className="max-w-sm text-sm text-(--nous-fg-3)">
        ...
        <section aria-labelledby="guidance-heading" className="space-y-3">
          ...
          <Card className="h-full rounded-2xl border-(--nous-border-1) bg-(--nous-bg-2) shadow-none">
            <CardHeader className="flex-row items-center gap-3 space-y-0 pb-2">
              ...
              <CardTitle className="text-base text-(--nous-fg-1)">
            ...
            <CardContent>
              <ul className="space-y-2.5">
                {ROTATION_GUIDANCE.map((item) => (
                  <li
                    key={item}
                    className="flex gap-2.5 text-sm text-(--nous-fg-2)"
                  >
                    <span
                      className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-(--nous-sol)"
                      aria-hidden="true"
                    />
                    {item}
                  </li>
