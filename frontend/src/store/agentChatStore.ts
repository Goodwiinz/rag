...
export const useAgentChatStore = create<AgentChatStore>()(
  immer((set, get) => ({
    ...
    // Messages — stub, will be wired to API in Task 5
    sendMessage: async () => {
      // No-op stub: real implementation will call agentChatService.execute()
    },
    ...
    // Stubs — will be wired to API in Task 5
    loadThreads: async () => {
      // No-op stub: real implementation will call agentChatService.listThreads()
    },

    loadThreadMessages: async (_threadId: string) => {
      // No-op stub: real implementation will call agentChatService.getThreadMessages()
    },
